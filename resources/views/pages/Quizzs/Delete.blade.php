...
<div class="modal fade" id="Delete_Student{{$quizz->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="{{route('Quizzs.destroy','test')}}" method="post">
                    @csrf
                    @method('DELETE')
                    ...
                    <input type="text" readonly value="{{$quizz->name}}" class="form-control">
