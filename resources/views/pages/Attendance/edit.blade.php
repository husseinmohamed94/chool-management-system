...
@section('content')
    <div class="page-title">
        <div class="row">
            <div class="col-sm-6">
                <h4 class="mb-0"> </h4>
                <h3>{{trans('Students_trans.PaymentSudents')}}{{$payment->students->name}}</h3>
            </div>
            <div class="col-sm-6">
        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('PaymentSudents.update','test') }}" autocomplete="" enctype="multipart/form-data">
                       @method('PUT')
                        @csrf
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input  type="number" name="Debit"  value="{{$payment->amount}}" class="form-control">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input  type="text" name="final_balance"   value="{{number_format($payment->students->studentaccount->sum('Debit')  - $payment->students->studentaccount->sum('credit'),2) }}"  readonly  class="form-control">
                                </div>
                            </div>
