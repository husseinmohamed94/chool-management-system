                                ...
                                <div data-repeater-list="List_Fees">
                                    <div data-repeater-item>
                                        <div class="row">
                                            ...
                                            <div class="col">
                                                <label for="Name_en" class="mr-sm-2">{{ trans('Class_trans.Processes') }}:</label>
                                                <input class="btn btn-danger btn-block" data-repeater-delete type="button" value="{{ trans('Class_trans.delete_row') }}" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
