        ...
        <div class="col-md-12 mb-30">
            <div class="card card-statistics h-100">
                <div class="card-body">
                    ...
                    <form method="post"  action="{{ route('Fee.update',$fee->id) }}" autocomplete="" >
                        @method('PUT')
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input  type="text" name="title_ar" value="{{$fee->getTranslation('title','ar')}}"  class="form-control">
                                </div>_
                            </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input  class="form-control" value="{{$fee->getTranslation('title','en')}}" name="title_en" type="text" >
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                        ...
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="inputState">{{trans('Fees_trans.Grade')}}</label>
                                <textarea name="description" class="form-control">{{$fee->description}}</textarea>
                            </div>
                        </div>
