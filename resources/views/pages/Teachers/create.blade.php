...
<div class="page-title">
    <div class="row">
        <div class="col-sm-6">
            <h4 class="mb-0">  {{trans('Teachers_trans.Teachers')}}</h4>

        </div>
        <div class="col-sm-6">
            <ol class="breadcrumb pt-0 pr-0 float-left float-sm-right ">
                <li class="breadcrumb-item"><a href="#" class="default-color">{{trans('main_trans.Dashboard')}}</a></li>
                <li class="breadcrumb-item active">{{trans('Teachers_trans.Teachers')}}</li>
            </ol>
        </div>
    </div>
</div>
                ...
                <div class="col-xs-12">
                    <div class="col-md-12">
                        ...
                        <form action="{{route('Teachers.store')}}" method="post">
                            ...
                            <button class="btn btn-success btn-sm nextBtn btn-lg pull-right" type="submit">{{trans('Teachers_trans.Next')}}</button>
                        </form>
                    </div>
                </div>
            </div>
