 ...
 Main content -->
        ...
        <div class="content-wrapper">
            <div class="page-title">
                <div class="row">
                    <div class="col-sm-6">
                        <h4 class="mb-0">  {{trans('main_trans.Admin')}}</h4>
                    </div>
                    <div class="col-sm-6">
                            ...
                            <div class="clearfix">
                                <div class="float-left">
                                    <span class="text-danger">
                                        <i class="fa fa-user-circle fa-user-graduate highlight-icon" aria-hidden="true"></i>
                                    </span>
                                </div>
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{trans('main_trans.countstudents')}}</p>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{trans('main_trans.countteacher')}}</p>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{trans('main_trans.countparent')}}</p>
                    ...
                    <div class="card card-statistics h-100">
                        <div class="card-body">
                            <div class="clearfix">
                                ...
                                <div class="float-right text-right">
                                    <p class="card-text text-dark">{{trans('main_trans.countSection')}}</p>
                                    <h4>{{ App\Models\Section::count() }}</h4>
                                </div>
                            </div>
                            <p class="text-muted pt-3 mb-0 mt-2 border-top">
                                <i class="fa fa-binoculars mr-1" aria-hidden="true"></i><a href="{{route('Section.index')}}" target="_blank"><span class="text-danger">عرض البيانات</span></a>
                            </p>
                        </div>
                    </div>
                </div>
